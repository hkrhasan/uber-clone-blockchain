...
import userProfile from '../temp/user-profile.png'
...
const style = {
    ...
    userImage: `h-10 w-10 rounded-full p-px object-cover cursor-pointer overflow-hidden`,
    ...
    <div className={style.wrapper}>
        ...
        <div className={style.rightMenu}>
            ...
            <div className={style.userImageContainer}>
                {currentAccount && <Image className={style.userImage} src={userProfile} width={40} height={40} />}
            </div>
            {currentAccount ? (
                <div>
